...
void game_start_screen() {
    glColor3f(1, 1, 0);
    utils_render_bitmap_string(217, 400, GLUT_BITMAP_TIMES_ROMAN_24, "SPACE INVADERS");
...
void display() {
    ...
    glColor3f(1, 1, 1);
    utils_render_bitmap_string(30, 60, GLUT_BITMAP_HELVETICA_10, "COMPUTER GRAPHICS LAB PROJECT");
    glColor3f(1, 1, 1);
    utils_render_bitmap_string(30, 40, GLUT_BITMAP_HELVETICA_10, "(221030114, 221030103)");
